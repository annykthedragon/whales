...
def main():
    ...
    if app_mode == "О проекте":
        ...
        if asset == "Недвижимость":
            ...
            #Создаем датафрейм с параметрами машины
            ...
            if st.sidebar.button('Рассчитать'):
                ...
                with st.spinner('На это уйдёт некоторое время...'):
                    ...
                    #Вычисляем и печатаем величины ошибок при сравнении известных цен машин из валидационной выборки с предсказанными моделью
                    print_metrics(rf_prediction, val_y)
